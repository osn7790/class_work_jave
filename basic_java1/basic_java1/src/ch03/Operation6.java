...
public class Operation6 {
    ...
    public static void main(String[] args) {
        ...
        int cartTotal = 50_000; // 장바구니 총액(원) 정수 숫자 단위에 _ 언더바 사용 가능
        ...
        // 무료 환불 조건 : 장바구니 총액이 10만원 이상이고 회원인 경우
        boolean freeRefund = (cartTotal >= 100_000) && isMember;
        System.out.println("무료 환불 가능 여부 : " + freeRefund);
