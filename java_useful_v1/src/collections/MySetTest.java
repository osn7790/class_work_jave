...
public class MySetTest {
    ...
    public static void main(String[] args) {
        ...
        // Set 계열을 Iterator 타입으로 변환해서 순회 시킬 수 있었다.
        ...
        System.out.println("무작위로 선택된 로 또 번호 6개 : " + lottoNumbers.toString());

        // HashSet 데이터 타입을 ArrayList 객체 생성시에 즉, 생성자에 인자값으로 넣을 수 있도록 설계 됨.
